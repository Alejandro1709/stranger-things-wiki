        ...
        <div className="space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Conoce a los héroes y aliados que luchan contra las fuerzas
              oscuras del Mundo del Revés
            </p>
          </div>
            ...
            <Card className="group hover:shadow-lg overflow-hidden transition-all duration-300 hover:-translate-y-1 cursor-pointer">
              ...
              <CardContent className="space-y-3">
                <p className="text-sm leading-relaxed text-muted-foreground">
                  ...
                  iure fugit culpa dignissimos quaerat. Beatae, praesentium
                  molestias dolor iusto commodi repellendus quod tempore,
                  quibusdam in ipsum, quasi id quis quidem?
                </p>
